...
[![repo standards badge](https://img.shields.io/badge/endpoint.svg?&style=flat&logo=github&url=https%3A%2F%2Foperations-engineering-reports.cloud-platform.service.justice.gov.uk%2Fapi%2Fv1%2Fcompliant_public_repositories%2Fhmpps-court-cases-release-dates-api)](https://operations-engineering-reports.cloud-platform.service.justice.gov.uk/public-report/hmpps-court-cases-release-dates-api "Link to report")
[![CircleCI](https://circleci.com/gh/ministryofjustice/hmpps-court-cases-release-dates-api/tree/main.svg?style=svg)](https://circleci.com/gh/ministryofjustice/hmpps-court-cases-release-dates-api)
[![Docker Repository on Quay](https://img.shields.io/badge/quay.io-repository-2496ED.svg?logo=docker)](https://quay.io/repository/hmpps/hmpps-court-cases-release-dates-api)
[![API docs](https://img.shields.io/badge/API_docs_-view-85EA2D.svg?logo=swagger)](https://hmpps-court-cases-release-dates-api-dev.hmpps.service.justice.gov.uk/webjars/swagger-ui/index.html?configUrl=/v3/api-docs)
...
Our security policy is located [here](https://github.com/ministryofjustice/hmpps-court-cases-release-dates-api/security/policy).
...
## Renaming from HMPPS Court Cases Release Dates Api - github Actions
...
```bash
docker compose pull && docker compose up --scale hmpps-court-cases-release-dates-api=0
```
